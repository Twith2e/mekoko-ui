...
export const AboutUs = () => {
  return (
    <div className="px-20 py-12 mt-20 flex gap-12 bg-[radial-gradient(ellipse_60%_80%_at_70%_50%,#FEF7ED_0%,#F2ECE6_100%)]">
      <div className="w-1/2">
        <h2 className="font-garamond text-5xl text-fluorescent-fire font-medium mb-6">
          The Mekoko Way
        </h2>
        <p className="font-sans text-base text-darkout">
